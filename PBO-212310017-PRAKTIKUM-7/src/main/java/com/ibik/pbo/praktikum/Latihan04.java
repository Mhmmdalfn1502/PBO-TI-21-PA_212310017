...
public class Latihan04 extends JFrame implements ActionListener {
    ...
    private void GenerateForm(Latihan04 frameForm) {
        ...
        title_form.setFont(new Font("Arial", Font.ITALIC, 20));
		...
		nilai_d.setBounds(180, 260, 35, 20);
        nilai_e.setBounds(220, 260, 35, 20); 
		nilai_f.setBounds(260, 260, 35, 20);
        ...
        final String data[][] = { {"212310017", "Lionel Alfan", "A"},
                            {"212310035", "Adrian Alghifari", "A"}, 
                            {"212310036", "Rayyan Putra Nagasa", "A+"} };
        final String kolom[] = {"NPM", "Nama", "Nilai"};

        JTable mhs_table = new JTable(data, kolom);
//        mhs_table.setBounds(700, 500, 350, 450);

        frameForm.add(mhs_table, BorderLayout.EAST);
        frameForm.setBounds(700, 500, 700, 500);
