...
public class KeyListenerGames extends JFrame implements KeyListener {
    ...
    private String images_path = "com/ibik/pbo/praktikum/image/";
    ...
    private void GenerateGamesUI(KeyListenerGames frame) {
        ...
        m_up = KeyListenerGames.class.getClassLoader().getResource(images_path + "up3.png");
        m_down =  KeyListenerGames.class.getClassLoader().getResource(images_path + "down3.png");
        m_left = KeyListenerGames.class.getClassLoader().getResource(images_path + "left3.png");
        m_right = KeyListenerGames.class.getClassLoader().getResource(images_path + "right3.png");
