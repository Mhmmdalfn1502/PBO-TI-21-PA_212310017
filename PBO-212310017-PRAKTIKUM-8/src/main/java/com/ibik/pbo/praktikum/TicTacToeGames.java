...
public class TicTacToeGames extends JFrame {
	...
	private void GenerateButtonUI(TicTacToeGames frame) {
	...
	private Boolean IsButtonSecondRowEquals() {
		return (buttons[3].getText().equals(buttons[4].getText()) && buttons[4].getText().equals(buttons[5].getText()));
	}

	private Boolean IsButtonThirdRowEquals() {
		return (buttons[6].getText().equals(buttons[7].getText()) && buttons[7].getText().equals(buttons[8].getText()));
	}

	// Check Columns
	private Boolean IsButtonFirstColumnEquals() {
		return ((buttons[0].getText().equals(buttons[3].getText())
				&& buttons[3].getText().equals(buttons[6].getText())));
	}

	private Boolean IsButtonSecondColumnEquals() {
		return (buttons[1].getText().equals(buttons[4].getText()) && buttons[4].getText().equals(buttons[7].getText()));
	}

	private Boolean IsButtonThirdColumnEquals() {
		return (buttons[2].getText().equals(buttons[5].getText()) && buttons[5].getText().equals(buttons[8].getText()));
	}

	// Check Zigzag
	private Boolean IsButtonLeftZigzagEquals() {
		return (buttons[0].getText().equals(buttons[4].getText()) && buttons[4].getText().equals(buttons[8].getText()));
	}

	private Boolean IsButtonRightZigzagEquals() {
		return (buttons[2].getText().equals(buttons[4].getText()) && buttons[4].getText().equals(buttons[6].getText()));
	}
